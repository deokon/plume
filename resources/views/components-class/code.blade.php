    ...
    @if ($title || $language)
        <div
            ...
            <div class="flex items-center gap-2">
                ...
                @if ($language)
                    <span
                        class="rounded bg-background-600 px-1.5 py-0.5 text-[10px] font-bold uppercase text-background-300 dark:bg-background-700">{{ $language }}</span>
                @endif
            </div>
            ...
            <button type="button" x-on:click="copy()"
                ...
                <x-plume::icon x-show="copied" i="icon-[fluent--checkmark-24-regular]"
