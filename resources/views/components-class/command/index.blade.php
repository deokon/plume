...
<div x-data="command()" @keydown.window.prevent.cmd.k="toggle()"
    ...
    @php $command = $component; @endphp
    <div @click="toggle()" class="inline-flex cursor-pointer" role="button" aria-haspopup="listbox"
        :aria-expanded="open">
        ...
        <div x-show="open" x-cloak x-transition:enter="{{ $enter }}"
            ...
            <div x-show="open" x-cloak x-transition:enter="{{ $enter }}"
                ...
                <div
                    ...
                    <input x-ref="input" x-model="search" type="text" role="searchbox"
                        aria-autocomplete="list" :aria-controls="$id('command-list')"
