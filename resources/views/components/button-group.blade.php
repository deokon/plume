...
@php
    $baseClass =
        'inline-flex rounded-md shadow-sm border border-background-400 dark:border-background-600 overflow-hidden';
    ...
    if ($stack) {
        ...
        $borderClasses =
            ' [&>*]:border-0 [&>*:not(:last-child)]:border-r [&>*]:border-background-400 dark:[&>*]:border-background-600';
    }
