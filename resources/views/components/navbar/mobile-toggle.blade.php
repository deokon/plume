...
<div class="-mr-2 flex items-center sm:hidden">
    ...
    >
        ...
        <x-plume::icon x-show="!mobileOpen" i="icon-[fluent--list-24-regular]" class="block size-6" />
        <x-plume::icon x-show="mobileOpen" i="icon-[fluent--dismiss-24-regular]" class="hidden size-6" />
    </button>
</div>
