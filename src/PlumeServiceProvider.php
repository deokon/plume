...
class PlumeServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        Blade::component('plume::carousel', \deokon\Plume\View\Components\Carousel\Carousel::class);
        Blade::component('plume::carousel.item', \deokon\Plume\View\Components\Carousel\Item::class);
        Blade::component('plume::chart', \deokon\Plume\View\Components\Chart::class);
        Blade::component('plume::code', \deokon\Plume\View\Components\Code::class);
        ...
        Blade::component('plume::navbar', \deokon\Plume\View\Components\Navbar\Navbar::class);
        Blade::component('plume::navbar.item', \deokon\Plume\View\Components\Navbar\Item::class);
        Blade::component('plume::navbar.logo', \deokon\Plume\View\Components\Navbar\Logo::class);
        Blade::component('plume::navbar.menu', \deokon\Plume\View\Components\Navbar\Menu::class);
        Blade::component('plume::navbar.mobile-menu', \deokon\Plume\View\Components\Navbar\MobileMenu::class);
        Blade::component('plume::navbar.mobile-item', \deokon\Plume\View\Components\Navbar\MobileItem::class);
        Blade::component('plume::navbar.mobile-toggle', \deokon\Plume\View\Components\Navbar\MobileToggle::class);
        ...
        Blade::component('plume::progress', \deokon\Plume\View\Components\Progress\Progress::class);
        Blade::component('plume::progress.percent', \deokon\Plume\View\Components\Progress\Percent::class);
        Blade::component('plume::search', \deokon\Plume\View\Components\Search\Search::class);
        Blade::component('plume::search.result', \deokon\Plume\View\Components\Search\Result::class);
        ...
        Blade::component('plume::stepper', \deokon\Plume\View\Components\Stepper\Stepper::class);
        Blade::component('plume::stepper.step', \deokon\Plume\View\Components\Stepper\Step::class);
        Blade::component('plume::stepper.actions', \deokon\Plume\View\Components\Stepper\Actions::class);
